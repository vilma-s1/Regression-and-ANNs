...
new_column1 = X[:, 0]*X[:, 1]
new_column1 = np.expand_dims(new_column1, axis=1)
X = np.append(X, new_column1, axis=1)
new_column2 = X[:, 0] ** 2
new_column2 = np.expand_dims(new_column2, axis=1)
X = np.append(X, new_column2, axis=1)
new_column3 = X[:, 1] ** 2
new_column3 = np.expand_dims(new_column3, axis=1)
X = np.append(X, new_column3,  axis=1)
new_column4 = X[:, 0] ** 3
new_column4 = np.expand_dims(new_column4, axis=1)
X = np.append(X, new_column4,  axis=1)
new_column5 = X[:, 1] ** 3
new_column5 = np.expand_dims(new_column5, axis=1)
X = np.append(X, new_column5,  axis=1)
