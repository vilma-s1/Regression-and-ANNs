...
def gradient_descent(X, y, theta, alpha, iterations, do_plot):
    ...
    for it in range(iterations):
        ...
        #     sigma[1] = sigma[1] + (hypothesis - output) * X[i, 1]
        #     sigma[2] = sigma[2] + (hypothesis - output) * X[i, 2]

        # theta_temp[0] = theta_temp[0] - (alpha / m) * sigma[0]
        #  theta_temp[1] = theta_temp[1] - (alpha / m) * sigma[1]
        #  theta_temp[2] = theta_temp[2] - (alpha / m) * sigma[2]
